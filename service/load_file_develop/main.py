...
#         """Bieżące wiersze pos_information (valid_to IS NULL) dla podanych art_key."""
#         if not art_keys:
...
#                 "FROM pos_information WHERE valid_to IS NULL AND art_key IN (" + placeholders + ")"
#             )
#             rows = conn.execute(q)
#             return pd.DataFrame(
#                 rows.fetchall(),
...
#                                         valid_from, last_modified_date, source_file, is_current)
#             VALUES (:art_key, :ean, :vat_rate, :price_net, :price_gross, :valid_from,
...
# # department -> ok
# # #
# # path='/Users/radoslaw/Desktop/Engineering-project/service/load_file_develop/data/generated_masterdata_part1_v3/pos_information.csv'
