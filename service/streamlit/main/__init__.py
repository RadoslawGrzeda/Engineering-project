...
class StreamlitApp:
    ...
    def _show_user_history(self):
        ...
        query =text("""SELECT file_name, processed_at, status FROM meta.product_etl_load_log WHERE user_name = :user_name ORDER BY
            processed_at DESC""")
        try:
...
#     processed_at         TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    def _send_file_information_to_db(self, user_name:str, destination_table:str,
        ...
        sql = text('''
                INSERT INTO meta.product_etl_load_log(
